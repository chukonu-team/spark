...
object TestSettings {
  ...
  lazy val settings = Seq (
    ...
    (Test / javaOptions) += "-Dspark.ui.enabled=true",
    // (Test / javaOptions) += "-Dspark.driver.bindAddress=0.0.0.0",
    (Test / javaOptions) += "-Dspark.driver.host=node0",
